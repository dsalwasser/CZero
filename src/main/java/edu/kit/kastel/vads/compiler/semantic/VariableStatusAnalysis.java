...
class VariableStatusAnalysis
    implements NoOpVisitor<Namespace<VariableStatusAnalysis.VariableStatus>> {
  ...
  public Unit visit(DeclarationTree declarationTree, Namespace<VariableStatus> data) {
    ...
    VariableStatus status =
        declarationTree.initializer() == null
  ...
  private static void updateStatus(
      Namespace<VariableStatus> data, VariableStatus status, NameTree name) {
    data.put(
        name,
        status,
